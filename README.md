...
[![smithery badge](https://smithery.ai/badge/@Dosugamea/voicevox-mcp-server)](https://smithery.ai/server/@Dosugamea/voicevox-mcp-server)
...
To install Voicevox MCP Server for Claude Desktop automatically via [Smithery](https://smithery.ai/server/Dosugamea/voicevox-mcp-server):

```bash
npx -y @smithery/cli install Dosugamea/voicevox-mcp-server --client claude
```
